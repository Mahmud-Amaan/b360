...
This project implements an AI-powered voice agent for a multi-tenant SaaS system. It allows tenants to provision phone numbers and handle inbound calls using a shared AI knowledge base. The system integrates with existing chat chatbots and tools, ensuring consistent behavior across text and voice channels. Key aspects:
